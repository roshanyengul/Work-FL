...
<div class="gt-right">    
     <a href="<?php echo esc_url( flourish_lite_live_demo ); ?>" target="_blank"><?php esc_html_e('Live Demo', 'flourish-lite'); ?></a> | 
    <a href="<?php echo esc_url( flourish_lite_theme_doc ); ?>" target="_blank"><?php esc_html_e('Documentation', 'flourish-lite'); ?></a>    
</div><!-- .gt-right-->
<div class="clear"></div>
</div><!-- .wrap-GT -->
<?php } ?>